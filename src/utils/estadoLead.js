...
// Descartado → manual, requiere motivo; reactivable (el motivo se limpia al
//              salir de Descartado). Bloquea cotizar/convertir.
...
export const ESTADO_LEAD_DESCARTADO = 'Descartado';
